...
export default function SuccessModal() {
  ...
  return (
    ...
    {login ? (
      ...
      <div className="max-w-md w-full bg-white rounded-3xl shadow-lg p-8 space-y-6 transition-all duration-500">
        ...
        <div className="pt-4">
          <button
            onClick={openLogin}
             className="w-2/3 py-2 px-4 bg-lime-700 text-white font-medium text-sm rounded-3xl shadow-sm hover:bg-lime-900 focus:outline-none focus:ring-2 focus:ring-lime-900 focus:ring-offset-2 transition duration-300"
          >
            Proceed to Login
          </button>
        </div>
